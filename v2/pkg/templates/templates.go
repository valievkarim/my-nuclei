...
import (
	...
	"github.com/valievkarim/my-nuclei/v2/pkg/protocols/common/variables"
	"github.com/valievkarim/my-nuclei/v2/pkg/protocols/dns"
	"github.com/valievkarim/my-nuclei/v2/pkg/protocols/file"
	"github.com/valievkarim/my-nuclei/v2/pkg/protocols/headless"
	"github.com/valievkarim/my-nuclei/v2/pkg/protocols/http"
	"github.com/valievkarim/my-nuclei/v2/pkg/protocols/network"
	"github.com/valievkarim/my-nuclei/v2/pkg/protocols/ssl"
	"github.com/valievkarim/my-nuclei/v2/pkg/protocols/websocket"
	"github.com/valievkarim/my-nuclei/v2/pkg/protocols/whois"
