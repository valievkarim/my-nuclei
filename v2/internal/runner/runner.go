...
import (
	...
	"github.com/valievkarim/my-nuclei/v2/internal/colorizer"
	"github.com/valievkarim/my-nuclei/v2/pkg/catalog"
	"github.com/valievkarim/my-nuclei/v2/pkg/catalog/config"
	"github.com/valievkarim/my-nuclei/v2/pkg/catalog/loader"
	"github.com/valievkarim/my-nuclei/v2/pkg/core"
	"github.com/valievkarim/my-nuclei/v2/pkg/core/inputs/hybrid"
	...
	"github.com/valievkarim/my-nuclei/v2/pkg/projectfile"
	"github.com/valievkarim/my-nuclei/v2/pkg/protocols"
	"github.com/valievkarim/my-nuclei/v2/pkg/protocols/common/automaticscan"
	"github.com/valievkarim/my-nuclei/v2/pkg/protocols/common/hosterrorscache"
	"github.com/valievkarim/my-nuclei/v2/pkg/protocols/common/interactsh"
	"github.com/valievkarim/my-nuclei/v2/pkg/protocols/common/protocolinit"
	"github.com/valievkarim/my-nuclei/v2/pkg/protocols/headless/engine"
	"github.com/valievkarim/my-nuclei/v2/pkg/protocols/http/httpclientpool"
	...
	"github.com/valievkarim/my-nuclei/v2/pkg/utils/stats"
	yamlwrapper "github.com/valievkarim/my-nuclei/v2/pkg/utils/yaml"
)
